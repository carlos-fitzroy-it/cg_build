...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    if (session) {
        // Signed in
        try {
            const responseData = await (0,_helpers_runTerminalCommand__WEBPACK_IMPORTED_MODULE_2__/* .runTerminalCommand */ .g)(`cd ${req.body.virtualHost} && git checkout -b ${req.body.repoBranch}`);
...
var __webpack_exports__ = __webpack_require__.X(0, [164,462], () => (__webpack_exec__(7492)));
